...
export function getMockDashboardData(): DashboardData {
  ...
  const tasks: TaskMetrics = {
    ...
    by_category: {
      standard: { pending: 120, in_progress: 2, completed: 850 },
      'test-suite': { pending: 58, in_progress: 0, completed: 315 },
      'deep-investigation': { pending: 40, in_progress: 0, completed: 200 },
    },
  ...
  return {
    ...
    runningItems: [
      ...
      },
      {
        ...
        elapsed: '7m',
        lastTool: 'Bash',
        lastActivity: new Date(Date.now() - 60 * 1000).toISOString(),
        sessionId: null,
      },
      {
        id: 'sq-abc003',
...
export function getMockPersistentTaskMonitorData(): PersistentTaskMonitorSectionData {
  const now = Date.now();
  return {
    hasData: true,
    tasks: [
      {
        id: 'pt-mock-1',
        title: 'Get AWS one-click demo passing E2E',
        status: 'active',
        cycleCount: 591,
        heartbeatAge: '0m',
        ...
        amendments: [
          {
            id: 'am-mock-1',
            type: 'addendum',
            content: 'Also verify the recording quality is above 720p',
            acknowledged: true,
          ...
          },
          {
            id: 'am-mock-2',
            type: 'scope_change',
            content: 'Include both Chrome and Firefox in the demo run',
            acknowledged: false,
        ...
        subTasks: [
          {
            id: 'st-mock-1',
            title: 'Investigate demo prerequisites',
            status: 'completed',
            section: 'INVESTIGATOR & PLANNER',
            agentId: null,
            agentElapsed: null,
          ...
          {
            id: 'st-mock-2',
            title: 'Fix hardcoded localhost:4000 in proxy config',
            status: 'completed',
            section: 'CODE-REVIEWER',
            agentId: null,
            agentElapsed: null,
            agentStage: null,
            agentProgressPct: null,
            prUrl: 'https://github.com/org/repo/pull/1460',
            prMerged: true,
          },
          {
            id: 'st-mock-3',
            title: 'Run demo with dev servers active',
            status: 'in_progress',
            section: 'DEMO-MANAGER',
            agentId: 'mnbubtrs',
            agentElapsed: '28m',
            agentStage: 'demo-manager',
            agentProgressPct: 42,
            prUrl: null,
            prMerged: false,
          },
          {
            id: 'st-mock-4',
            title: 'Verify demo recording quality',
            status: 'pending',
            section: 'DEMO-MANAGER',
            agentId: null,
            agentElapsed: null,
          ...
          {
            id: 'st-mock-5',
            title: 'Final user-alignment check',
            status: 'pending',
            section: 'INVESTIGATOR & PLANNER',
            agentId: null,
            agentElapsed: null,
        ...
        recentEvents: [
          {
            ...
            details: 'Auth refresh completed successfully',
          },
          {
            id: 'ev-mock-2',
            type: 'child_spawned',
            timestamp: new Date(now - 3 * 60 * 1000).toISOString(),
            details: 'Child launched run_demo for E2E scenario',
          },
          {
            id: 'ev-mock-1',
            type: 'cycle_start',
            timestamp: new Date(now - 4 * 60 * 1000).toISOString(),
            details: 'Suspended 3 low-priority sessions to free capacity',
          },
        ],
        demoInvolved: true,
        strictInfraGuidance: false,
        activatedAt: new Date(now - 4 * 60 * 60 * 1000).toISOString(),
        age: '4h',
      },
      {
        id: 'pt-mock-2',
        title: 'Refactor database layer to Drizzle ORM',
        status: 'paused',
        cycleCount: 34,
        heartbeatAge: '22m',
        heartbeatStale: true,
        ...
        subTasks: [
          {
            id: 'st-mock-6',
            title: 'Audit existing Knex queries',
            status: 'completed',
            section: 'INVESTIGATOR & PLANNER',
            agentId: null,
            agentElapsed: null,
          ...
          {
            id: 'st-mock-7',
            title: 'Migrate user module to Drizzle',
            status: 'pending',
            section: 'CODE-REVIEWER',
            agentId: null,
            agentElapsed: null,
        ...
        demoInvolved: false,
        strictInfraGuidance: false,
        activatedAt: new Date(now - 2 * 24 * 60 * 60 * 1000).toISOString(),
        age: '2d',
      },
    ],
    totalActive: 1,
