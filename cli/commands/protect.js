...
function doProtect(projectDir) {
  ...
  const criticalHooks = [
    ...
    'cto-worktree-subagent-guard.js',
    'playwright-cli-guard.js',
    'block-team-tools.js',
    'interactive-agent-guard.js',
    'interactive-lockdown-guard.js',
    'debate-mode-guard.js',
  ...
  const files = [
    ...
    path.join(protectedHooksDir, 'cto-worktree-subagent-guard.js'),
    path.join(protectedHooksDir, 'playwright-cli-guard.js'),
    path.join(protectedHooksDir, 'block-team-tools.js'),
    path.join(protectedHooksDir, 'interactive-agent-guard.js'),
    path.join(protectedHooksDir, 'interactive-lockdown-guard.js'),
    path.join(protectedHooksDir, 'interactive-heartbeat.js'),
    path.join(protectedHooksDir, 'debate-mode-guard.js'),
