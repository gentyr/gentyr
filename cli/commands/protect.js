...
function doProtect(projectDir) {
  ...
  const files = [
    ...
    path.join(protectedHooksDir, 'plan-merge-tracker.js'),
    path.join(protectedHooksDir, 'plan-persistent-sync.js'),
    path.join(protectedHooksDir, 'plan-activation-spawner.js'),
    path.join(protectedHooksDir, 'cto-alignment-spec-review.js'),
    path.join(protectedHooksDir, 'session-warning-triage.js'),
    path.join(protectedHooksDir, 'cto-turn-worktree-postuse.js'),
    path.join(protectedHooksDir, 'release-completion-hook.js'),
    path.join(protectedHooksDir, 'pause-persistent-task-guard.js'),
    path.join(protectedHooksDir, 'audit-lane-guard.js'),
...
function doUnprotect(projectDir) {
  ...
  const files = [
    ...
    path.join(hooksOwnershipDir, 'interactive-heartbeat.js'),
    path.join(hooksOwnershipDir, 'plan-briefing.js'),
    path.join(hooksOwnershipDir, 'plan-work-tracker.js'),
    path.join(hooksOwnershipDir, 'plan-merge-tracker.js'),
    path.join(hooksOwnershipDir, 'plan-persistent-sync.js'),
    path.join(hooksOwnershipDir, 'plan-activation-spawner.js'),
    path.join(hooksOwnershipDir, 'cto-alignment-spec-review.js'),
    path.join(hooksOwnershipDir, 'session-warning-triage.js'),
    path.join(hooksOwnershipDir, 'cto-turn-worktree-postuse.js'),
    path.join(hooksOwnershipDir, 'release-completion-hook.js'),
    path.join(hooksOwnershipDir, 'pause-persistent-task-guard.js'),
    path.join(hooksOwnershipDir, 'audit-lane-guard.js'),
    // Legacy / removed files — still unprotect them if they exist on disk from prior installs
    ...
    path.join(hooksOwnershipDir, 'deferred-action-audit-executor.js'),
    path.join(hooksOwnershipDir, 'bypass-request-router.js'),
    path.join(hooksOwnershipDir, 'bypass-pause-duration-guard.js'),
    ...
    path.join(hooksOwnershipDir, 'secret-env-scope-guard.js'),
    path.join(hooksOwnershipDir, 'secret-profile-gate.js'),
    path.join(hooksOwnershipDir, 'branch-checkout-guard.js'),
    path.join(hooksOwnershipDir, 'main-tree-commit-guard.js'),
    path.join(hooksOwnershipDir, 'spawned-main-tree-edit-guard.js'),
    path.join(hooksOwnershipDir, 'cto-worktree-subagent-guard.js'),
    path.join(hooksOwnershipDir, 'worktree-cwd-guard.js'),
    path.join(hooksOwnershipDir, 'worktree-remove-guard.js'),
    path.join(hooksOwnershipDir, 'worktree-sync-guard.js'),
    path.join(hooksOwnershipDir, 'worktree-path-guard.js'),
    path.join(hooksOwnershipDir, 'block-team-tools.js'),
    path.join(hooksOwnershipDir, 'playwright-cli-guard.js'),
    path.join(hooksOwnershipDir, 'pr-base-guard.js'),
    path.join(hooksOwnershipDir, 'interactive-agent-guard.js'),
    path.join(hooksOwnershipDir, 'interactive-lockdown-guard.js'),
    path.join(hooksOwnershipDir, 'debate-mode-guard.js'),
    path.join(hooksOwnershipDir, 'staging-lock-guard.js'),
    path.join(hooksOwnershipDir, 'demo-local-guard.js'),
