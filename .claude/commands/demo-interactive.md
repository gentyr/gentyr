...
3. Exclude infrastructure projects (`setup`, `seed`, `auth-setup`, `cleanup`) only — manual projects are fine in interactive mode since `page.pause()` works with the UI runner
