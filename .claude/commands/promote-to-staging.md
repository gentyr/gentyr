...
### Step 3: Show Drift Summary

Show the user:

1. The number of commits to be promoted (count the lines from Step 2).
...
### Step 4: Trigger the Preview-Promoter

All promotions go through the preview-promoter agent with full quality gates.
...
- `GENTYR_PROMOTION_PIPELINE=true` env var
