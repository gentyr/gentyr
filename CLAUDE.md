...
- Deferred action required to disable: `set_lockdown_mode({ enabled: false })` creates a deferred action; CTO approves via `record_cto_decision`, independent auditor verifies, then auto-executes
