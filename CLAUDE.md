...
- Headed demos, chrome-bridge scenarios, and extension demos always run locally — Fly.io executes headless by default (no Xvfb). Xvfb + ffmpeg recording is only started when `DEMO_HEADLESS != 1` (currently unused remotely).
